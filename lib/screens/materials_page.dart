...
class MaterialsPage extends StatefulWidget {
  // 1. Tambahkan variabel userId
  final String userId;

  // 2. Wajibkan userId di constructor
...
class _MaterialsPageState extends State<MaterialsPage> {
  ...
  Future<List<CourseModel>> fetchCourses() async {
    ...
    // 3. GUNAKAN widget.userId (DINAMIS)
    // Sekarang ID-nya tidak lagi dipaksa '1', tapi sesuai siapa yang login
