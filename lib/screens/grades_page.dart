...
class GradesPage extends StatefulWidget {
  ...
  // Jika belum dipassing dari MainNavigation, kita set default atau required
  // Untuk saat ini kita buat opsional dgn default value agar tidak error pas testing manual, 
  // tapi nanti wajib dipassing.
...
class _GradesPageState extends State<GradesPage> {
  ...
  // Helper: Hitung IPS (Indeks Prestasi Semester)
      ...
      body: FutureBuilder<List<GradeModel>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            final ips = _calculateIPS(grades); // Hitung IPS otomatis
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        ips.toStringAsFixed(2), // Tampilkan 2 angka belakang koma
  ...
  Widget _buildGradeCard(GradeModel item) {
    // Tentukan warna berdasarkan kelulusan
