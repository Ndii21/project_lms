...
import 'dart:convert';
import '../models/dashboard_data.dart'; // Pastikan path ini benar
import 'notification_popup.dart'; // Pastikan path ini benar
...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Future<DashboardData> fetchDashboardData() async {
    ...
    // Kirim ID User yang didapat dari Login (via widget.userId)
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Bagian Info
                        const Text('Informasi Terkini', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF2C3E50))),
                        const SizedBox(height: 12),
